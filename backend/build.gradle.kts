plugins {
    ...
    id("org.flywaydb.flyway") version "9.8.3" // flyway is managed by quarkus, so this should match the version in Git Repository eg "https://github.com/quarkusio/quarkus/blob/2.5.1.Final/bom/application/pom.xml"
